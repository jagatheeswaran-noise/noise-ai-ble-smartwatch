...
public final class DeviceSettingLiveData {
    ...
    //戒指NFC睡眠错误信息
    private final UnFlawedLiveData<Integer> ringNFCSleepError;
    //世界时钟列表
    ...
    public UnFlawedLiveData<Integer> getRingNFCSleepError() {
        return ringNFCSleepError;
    }
    ...
    private DeviceSettingLiveData() {
        ...
        ringNFCSleepError = new UnFlawedLiveData<>();
